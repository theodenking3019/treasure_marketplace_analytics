...
marketplace_txs = get_contract_transactions(api_key, contract_addresses['treasure_marketplace'])
...
for tx_wallet in marketplace_buys_df["from"].unique():
    magic_txs = get_contract_transactions(api_key, contract_addresses['magic'], from_address=tx_wallet, tx_type="tokentx")
    try:
